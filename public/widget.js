...
(function (global) {
  ...
  function injectStyles(accentColor, containerId) {
    ...
    var css = [
      ...
      '.valcr-label{font-size:11px;font-weight:500;color:rgba(200,200,220,0.55);letter-spacing:0.04em;text-transform:uppercase}',
      '.valcr-input-wrap{position:relative;display:flex;align-items:center}',
      '.valcr-prefix,.valcr-suffix{font-size:13px;color:rgba(200,200,220,0.4);position:absolute;pointer-events:none;font-weight:400}',
      '.valcr-prefix{left:10px}.valcr-suffix{right:10px}',
      '.valcr-input{width:100%;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;padding:8px 10px;font-size:13px;color:#f0f0fa;outline:none;transition:border-color 0.15s,background 0.15s;-moz-appearance:textfield;box-sizing:border-box}',
      ...
      '.valcr-result-card{background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:12px 14px}',
      '.valcr-result-card.highlight{background:' + accentColor + '12;border-color:' + accentColor + '35}',
      '.valcr-result-label{font-size:10px;color:rgba(200,200,220,0.5);font-weight:500;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px}',
      '.valcr-result-value{font-size:22px;font-weight:700;letter-spacing:-0.02em;color:#f0f0fa;font-variant-numeric:tabular-nums;line-height:1.1}',
      '.valcr-result-card.highlight .valcr-result-value{color:' + accentColor + '}',
      '.valcr-result-value.negative{color:#ff6b6b}',
      '.valcr-footer{padding:10px 20px;border-top:1px solid rgba(255,255,255,0.05);display:flex;align-items:center;justify-content:space-between}',
      '.valcr-powered{font-size:10px;color:rgba(200,200,220,0.25);text-decoration:none;transition:color 0.15s;letter-spacing:0.02em}',
      ...
      '.valcr-lead-label{font-size:11px;font-weight:500;color:rgba(200,200,220,0.5);letter-spacing:0.04em;text-transform:uppercase;margin-bottom:8px}',
      '.valcr-lead-row{display:flex;gap:8px}',
      '.valcr-lead-input{flex:1;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;padding:9px 12px;font-size:13px;color:#f0f0fa;outline:none;transition:border-color 0.15s;box-sizing:border-box}',
      '.valcr-lead-input:focus{border-color:' + accentColor + '80}',
      '.valcr-lead-input::placeholder{color:rgba(200,200,220,0.25)}',
      '.valcr-lead-btn{background:' + accentColor + ';color:#0d0d12;border:none;border-radius:8px;padding:9px 16px;font-size:12px;font-weight:700;cursor:pointer;transition:opacity 0.15s;white-space:nowrap;letter-spacing:0.02em}',
  ...
  // ─── Validation ─────────────────────────────────────────────────────────────
  function validateEmbedKey(embedKey, calcSlug, domain) {
  ...
  ValcrWidget.prototype._render = function () {
    ...
    html += '<span class="valcr-accent-dot"></span></div></div>';
    html += '<div class="valcr-body"><div class="valcr-inputs">';
    ...
    html += '</div><div class="valcr-results" id="' + this.id + '-results">';
